...
<div class="row">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-random"></i> Documentos Esperados</h2>
    ...
    {!!Form::open(['route'=>'esperados.store','method'=>'POST'])!!}
    ...
    @foreach ($esperadolista as $esperado)
   <div class=" col-sm-2">

    <label>

      {!!Form::checkbox('esperado_id[]', $esperado->id, false)!!} {!!$esperado->nombre!!}
