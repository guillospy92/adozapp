   ...
   @endif
      ...
      <div class="row">
        ...
        @if($clientt == 0)
          ...
          <script>
            alert('no hay clientes asociados con esta subarea para solucionar esto \nen el panel de administracion en la parte de clientes asocie un cliente con la subarea ');
          </script>
        ...
        @else
          @foreach($client as $clientes)
            ...
            <div class="col-md-3">
              <a href="{{route('anos',array($archivo,$clientes->id))}}" >

                <img class="carpeta img-responsive center-block" src="{{asset('images/carpeta.png')}}">
                <p class="text-center carpeta-texto"><strong>{{$clientes->nombre}}</strong></p>
