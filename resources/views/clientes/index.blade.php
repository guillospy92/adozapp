...
<div class="row">
    ...
    <tr>
        ...
        <td class="center obtenerestado">{{$cliente->estado}}</td>
        <td class="center obtenerfecha">{{$cliente->created_at}}</td>

        <td class="center">
            <a data-toggle="modal" data-target="#mymodalver" href=""  class="vercliente btn btn-success"  data-path="{{$cliente->id}}">
                <i class="glyphicon glyphicon-zoom-in icon-white"></i>
                Ver
            </a>
            <a data-toggle="modal" data-target="#mymodalupdate" href=""  class="actualizar btn btn-info"  data-path="{{$cliente->id}}">
...
<script>
 ...
 @if(Session::has('mesas'))
          ...
          alert("los datos fueron asociados correctamente");
           ...
           @if(Session::has('mesas_error'))

                    <script>

                    alert("no se completo la operacion porque ya existe un registro");
